...
('abstract','a.抽象的 n.摘要,文摘,梗概 vt.提取;摘录要点'),
('absurd','a.荒谬的，荒诞的，荒唐可笑的;不合理的'),
('abundance','n.丰富，充裕，大量'),
('abundant','a.大量(充足)的;(in)丰富(富裕)的'),
('abuse','vt.滥用;虐待，辱骂;诋毁 n.滥用;恶习;弊端'),
('academic','a.学院的，学术性的;大学的;理论的'),
...
('bosom','n.胸，胸部，乳房，胸怀;内心;a.亲密的，知心的'),
...
('charge','v.索(价);控告;充电 n.(pl.)费用,代价;电荷'),
...
('choice','n.选择(机会),抉择,选择项;入选者 a.精选的'),
...
('counter','n.柜台;计数器 a./ad.相反(的) v.反对,反击'),
...
('curtain','n.窗帘,门帘;幕(布);结束; vt 遮掩'),
('curve','n.曲线,弯曲(物) v.弄弯,成曲形'),
('cushion','n.垫子,软垫 vt.装垫子;缓和,减轻;'),
('custom','n.习惯,风俗,惯例;(pl.)海关,关税'),
('customary','a.习惯的,惯例的'),
('customer','n.顾客,主顾'),
('cut','n./v.切，割，削;削减，删节 n.切口，伤口'),
('cyberspace','n.虚拟信息空间;网络空间'),
...
('daughter','n.女儿'),
('dawn','n.黎明,拂晓 v.破晓;开始现出'),
('day','n.天，一昼夜;白昼，白天;时期，时代'),
('daylight','n.日光,白昼,黎明'),
('daytime','n.白天,日间'),
('dazzle','v.使惊奇,使倾斜;耀(眼) n.耀眼的光'),
('dead','a.死的;无生命的;死气沉沉的 ad.完全地'),
('deadline','n.最后期限'),
('deadly','a.致命的;势不两立的; 极度的;必定的'),
('deaf','a.聋的;不愿听的'),
('deal','v.处理;做买卖,经营;分配;对待 n.交易'),
('dealer','n.商人'),
...
('federation','n.同盟;联邦;联合;联盟;联合会'),
('fee','n.费(会费,学费等);酬金'),
('feeble','a.虚弱的,无力的'),
('feed','v.(on,with)喂养,饲养;(with)向„供给'),
('feedback','n.反馈;反应;回授'),
('feel','v.触;认为 vi.摸上去有„感觉;摸索;觉得'),
('feeling','n.感情;心情;知觉;同情'),
('fell','v.击倒;打倒(疾病等);砍伐 a.凶猛的;可怕的'),
('fellow','n.人,家伙;伙伴,同事 a.同样的,同事的'),
('fellowship','n.伙伴关系;联谊会,团体'),
('female','n.女性;女人;雌兽 a.女性的;雌的;柔弱的'),
('feminine','a.女性的;娇柔的'),
('fence','n.篱笆;围栏;剑术 v.用篱笆瓦围住;击剑'),
('ferry','n.摆渡;渡船;渡口 v.摆渡;渡运(人,车或物等)'),
('fertile','a.肥沃的,富饶的;能繁殖的'),
('fertilizer','n.(fertiliser)肥料'),
('festival','n.节日;音乐节;戏剧节 a.节日的;快乐的'),
('fetch','v.取来;接来;引出;售得;吸引 n.取得;拿'),
('feudal','a.封建的;封地的;领地的'),
('fever','n.发热,狂热'),
('few','几乎没有的'),
...
('figure','n.体形;轮廓;数字;图形 v.描绘;计算;推测'),
('file','n.锉刀;文件,档案 v.锉'),
('fill','v.(with)填满,充满'),
...
('finite','有穷的,限定的'),
('fire','n.火;火灾，失火;炉火 vi.开火 vt.放(枪)'),
('fireman','n.消防队员'),
('fireplace','n.壁炉'),
('firm','a.坚固的;坚决的,坚定的 n.公司,商号'),
('first','a./ad.第一;最初;首次 n.开始 pron.第一名'),
('fish','n.(pl.fish(es))鱼;鱼肉 v.捕鱼;钓鱼'),
('fisherman','n.渔夫，捕鱼人'),
('fist','n.拳头 vt.用拳头打;紧握'),
('fit','a.(病的)发作，痉挛 v./a.n.合适,试穿,安装'),
('fitting','a.适当的,恰当的 n.(常 pl.)配件,附件;装配'),
('five','num.五 pron./a.五(个，只...)'),
('fix','v.(使)固定;修理;安装;决定;注视 n.困境'),
...
('flat','a.平坦的,扁平的,平淡的 n.一套房间;平面'),
('flatter','vt.奉承;使高兴;使满意;胜过'),
('flavor','n.(flavour)情味;风味;滋味 v.给„调味'),
...
('flow','v.流,流动 n.流量,流速'),
('flower','n.花;精华，精粹，精英;盛时 vi.开花'),
('flu','n.(influenza)流行性感冒'),
('fluctuate','v.(使)波动;(使)起伏'),
('fluent','a.流利的,流畅的'),
('fluid','a.流动的,液体的 n.流体,液体'),
('flush','n.脸红 v.发红;奔流 a.洋溢的;富裕的;齐平的'),
('fly','n.飞行;苍蝇 v 飞行;飘杨 a.机敏的'),
('foam','v./n.泡沫,起泡沫'),
('focus','n.焦点,(活动,兴趣等的)中心 v.(on)使聚集'),
('fog','n.雾气，雾 v.以雾笼罩，被雾笼罩'),
('fold','v.折叠;合拢;抱住 n.褶,褶痕;羊栏;信徒'),
('folk','n.人们;民族;亲属 a.民间的'),
('follow','v.跟随,接着;领会;沿着„前进,遵循;结果是'),
...
('football','n.足球'),
('footstep','n.脚步(声),足迹'),
('for','prep.为了;给;代替;向;支持 conj.因为?'),
('forbid','v.禁止,不许'),
('force','n.力量,力;势力;(pl.)(总称)军队 v.强迫'),
...
('foul','a.污秽的;邪恶的 v.弄脏;妨害;犯规 n.犯规'),
...
('green','a.绿色的;生的;未成熟的 n.绿色;蔬菜;植物'),
('greenhouse','n.温室'),
...
('guest','n.客人,宾客,旅客'),
('guidance','n.引导,指导'),
('guide','n.领路人;指南,导游 v.领路;指导;支配;管理'),
...
('harvest','n.收获,收成;成果,后果 v.收获,收割'),
('haste','n.匆忙,急速;草率 v.赶快;匆忙'),
('hasty','a.匆忙的,仓促的;草率的'),
('hat','n.帽子(一般指有边的帽子)'),
('hatch','v.孵,孵出;策划,图谋 n.舱口,小门'),
('hate','v.恨,憎恨;不愿,不喜欢 n.恨,憎恶'),
('hatred','n.憎恨,憎恶,怨恨'),
('haul','v.拖曳,拖运,用力拖'),
('have','v.有，具有;体会，经受;从事;使;吃，喝'),
('hawk','n.鹰,隼'),
('hay','n.干草'),
...
('high','a.高的，高度的，高级的，高尚的 ad.高高地'),
('highland','n. 高地,高原'),
('highlight','v.使显著,使突出;强调 n.最精彩的部分'),
('highly','ad.高度地,很,非常;赞许地'),
('highway','n.公路,大路'),
('hijack','v.劫持，劫机，拦路抢劫'),
...
('however','ad.然而，可是，不过，无论如何 conj.无论'),
('howl','n.怒吼，嗥叫 vi.(风等)怒吼，咆哮'),
('huddle','n./v.拥挤;聚集 v.(因寒冷、害怕而)缩成一团'),
('hug','v./n.热烈拥抱,紧抱'),
('huge','a.巨大的,庞大的'),
('hum','v.哼曲子;发嗡嗡声;忙碌 n.嗡嗡声，嘈杂声'),
('human','a.人的,人类的 n.人'),
...
('hunger','n./v.饥饿;渴望'),
('hungry','a.饥饿的,渴望的'),
('hunt','v./n.打猎,猎取;(for)搜索;寻找'),
('hurl','vt.猛投，力掷;大声叫骂'),
('hurricane','n.飓风'),
('hurry','vi.匆忙 vt.催促;急运(派) n.急(匆)忙'),
('hurt','n.伤痛,伤害 v.刺痛,伤害;伤„的感情'),
('husband','n.丈夫'),
('hut','n.小屋,棚屋'),
('hydrogen','n.氢'),
('hypocrisy','n.伪善，虚伪'),
...
('imperative','n.命令;需要;规则;祈使语气 a.强制的;紧急的'),
...
('inferior','a.下等的,下级的;劣等的,差的 n.下级,晚辈'),
('infinite','a.无限的,无穷的 n.无限'),
('inflation','n.通货膨胀'),
('influence','n.(on)影响,感化;势力,权势 v.影响,感化'),
...
('innovation','n.改革，革新;新观念，新方法，新发明'),
...
('into','prep.到...里面，进入;成为(表示变化)'),
('intricate','a.复杂的,错综的,难以理解的'),
('intrigue','n.阴谋 v.密谋,私通;激起„的兴趣;诡计取得'),
...
('northern','a.北方的,北部的'),
('northwest','n.西北方,西北部 a.西北的 ad.向西北,在西北'),
...
('notice','n.通知,通告,布告;注意,认识 v.注意到,注意'),
...
('otherwise','ad.另样,用别的方法;在其他方面 conj.要不然'),
...
('pack','v.捆扎,打包;塞满,挤满 n.包裹,背包,一群/副'),
...
('puff','n.一阵,一股(气味等);喘息;吹嘘 v.喘息,鼓吹'),
...
('range','n.范围,领域;排列,连续;(山)脉 v.排列成行'),
...
('service','n.服务;公共设施;维修保养;行政部门 v.维修'),
...
('share','v.(with)分配,共用;分担 n.一份,份额;股份'),
('shark','n.鲨鱼'),
('sharp','a.锋利的;轮廓分明的;急转的 ad.(指时刻)正'),
...
('sound','n.声音 v.发声,响 a.健全的,完好的;正当的'),
('soup','n.汤'),
...
('speculate','vi.思索;推测 vt.投机;思索，推测'),
...
('stalk','n.茎，梗 vt.悄悄地跟踪 vi.高视阔步地走'),
...
('stay','vi.逗留;保持 vt.停止，延缓 n.逗留，停留'),
('steady','a.稳定的,不变的;坚定的 v.(使)稳固/稳定'),
('steak','n.牛排;大块肉(或鱼)片'),
('steal','v.偷,窃取;偷偷地做,巧取'),
('steam','n.水汽,蒸汽,水蒸气 v.蒸发;蒸;用蒸汽开动'),
('steamer','n.汽船,轮船'),
('steel','n.钢'),
('steep','a.陡峭的;险峻的;急剧升降的 vt.浸泡,沉浸'),
...
('street','n.街，街道;行车道'),
('strength','streŋkθ+ n.力，力量;实力;长处，优点;人力;兵力'),
('strengthen','v.加强,巩固'),
('strenuous','a.费力的，艰辛的;奋发的，努力的'),
('stress','n.压力;重要性;应力;重音 vt.强调，重读'),
...
('stroll','n.&v.漫步;散步;游荡'),
('strong','strɔ:ŋ+ a.强壮的,强大的;强烈的,浓的'),
...
('such','a.这样的;上述的 ad.那么 pron.这样的人/事物'),
('suck','v.&n.吸，舐;吸收(取)'),
('sudden','a.出乎意料的，突然的'),
('sue','v.控告,对„提出诉讼,起诉'),
...
('swallow','n.燕子;吞咽 vt.吞,咽;轻信;忍受;vi.咽口水'),
...
('sweet','a.甜的;可爱的,美好的 n.(常 pl.)糖果;甜食'),
...
('traitor','n.叛徒,卖国贼'),
('tram','n.有轨电车'),
('tramp','n./v 步行;沉重的脚步声(走)v.践踏 n.流浪者'),
...
('transport','v.运输,运送,搬运 n.运输;运输系统,运载工具'),
...
('triple','n.三倍数 a.三倍的;三部分构成的 v.使成三倍'),
...
('tropic','热带地区'),
('tropical','a.热带的'),
('trouble','n.烦恼;动乱;疾病;故障;辛苦 v.(使)烦恼'),
...
('weekday','n.平常日,工作日'),
('weekend','n.周末'),
('weekly','a.每星期的,一周的 ad.每周一次 n.周刊,周报'),
...
('wrong','rɔ:ŋ+ a.错的 ad.错误地，不正确地 n.错误 v.委屈'),
('X-ray','n.X 射线,X 光'),
('yard','n.院子,场地;码'),
('yawn','v.打呵欠 n.呵欠'),
